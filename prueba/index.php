...
<body>
    <h1>Libreria Los Tres Tristes Tigres</h1>
	<div class="container">
        <?php
        ...
        <?php }else{ ?>
		<a href="https://www.configuroweb.com/desarrollo/" align="center"><h2>INICIAR SESIÓN</h2></a>
		...
		<div class="regisFrm">
            ...
            <p>¿No tienes cuenta aún? <a href="registration.php">Regístrate aqui</a></p>
		</div>
        <?php } ?>
	</div>
</body>
